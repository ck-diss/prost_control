...
std::chrono::high_resolution_clock::time_point time_first;
std::chrono::high_resolution_clock::time_point time_later;
...
uint8_t dmp_read_fifo(int16_t *gyro, int16_t *accel, int32_t *quat, int16_t *sensors, uint8_t *more)
{
	...
	/* Get a packet. */
    //time_first = get_time::now();
    if (mpu_read_fifo_stream(dmp.packet_length, fifo_data, more)) {
        // edit: causes delay!!
		return 1;
    }
    //time_later = get_time::now();
    //qDebug() << "imu delay: " << std::chrono::duration_cast<std::chrono::microseconds>(time_later - time_first).count();
